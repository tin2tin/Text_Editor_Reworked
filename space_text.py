...
class TEXT_MT_format(Menu):
    ...
    def draw(self, _context):
        ...
        layout.operator_menu_enum("text.trim_whitespace", "type")

        layout.separator()

        layout.operator_menu_enum("text.convert_case", "type")
        layout.operator_menu_enum("text.punctuations", "type")
...
class TEXT_MT_edit(Menu):
    ...
    def draw(self, _context):
        ...
        layout.operator_menu_enum("text.split_join_lines", "type")
